  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.heading}>User List</Text>
       <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('PostRequest')}>
        ...
        {users.map((user) => {
          return (
            <View key={user.id} style={styles.card}>
              ...
              <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('PatchRequest', { userId: user.id })}>
                <Text style={styles.buttonText}>
                  Edit
                </Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.button} onPress={() => deleteUser(user.id)}>
                <Text style={styles.buttonText}>
                  Delete
                </Text>
              </TouchableOpacity>
